...
lv_obj_t *ui_Settings = NULL;lv_obj_t *ui_Group_Header1 = NULL;lv_obj_t *ui_Head_Group2 = NULL;lv_obj_t *ui_Label_Time2 = NULL;lv_obj_t *ui_LabeL_PM1 = NULL;lv_obj_t *ui_Label_Temp1 = NULL;lv_obj_t *ui_Label_Celsius1 = NULL;lv_obj_t *ui_Label_Battery1 = NULL;lv_obj_t *ui_Settings_Content = NULL;lv_obj_t *ui_Roller = NULL;lv_obj_t *ui_Roller1 = NULL;lv_obj_t *ui_Brightness_Group = NULL;lv_obj_t *ui_Brightness_Label = NULL;lv_obj_t *ui_Slider2 = NULL;lv_obj_t *ui_Brightness_Percent = NULL;lv_obj_t *ui_Volum_On = NULL;lv_obj_t *ui_Volume_Off = NULL;lv_obj_t *ui_Chart_Group = NULL;lv_obj_t *ui_Chart_Label = NULL;lv_obj_t *ui_Panel1 = NULL;lv_obj_t *ui_chart_scrollbar = NULL;lv_obj_t *ui_Chart2 = NULL;lv_obj_t *ui_Panel2 = NULL;lv_obj_t *ui_Group_Max_Speed1 = NULL;lv_obj_t *ui_Label_Max_Speed1 = NULL;lv_obj_t *ui_Label_Max_Speed_Number1 = NULL;lv_obj_t *ui_Label_kmh4 = NULL;lv_obj_t *ui_Group_AVG_Speed1 = NULL;lv_obj_t *ui_Label_AVG_Speed1 = NULL;lv_obj_t *ui_Label_AVG_Speed_Number1 = NULL;lv_obj_t *ui_Label_kmh5 = NULL;lv_obj_t *ui_Label_Number6 = NULL;lv_obj_t *ui_Menu1 = NULL;lv_obj_t *ui_BTN_Settings1 = NULL;
// event funtions
